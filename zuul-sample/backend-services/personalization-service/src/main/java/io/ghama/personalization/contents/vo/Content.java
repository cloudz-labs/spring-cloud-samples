package io.ghama.personalization.contents.vo;
...
public class Content implements Serializable {
	...
	private static final long serialVersionUID = 9150104525492194679L;
	...
	public String toString() {
		return "Content [id=" + id + ", category=" + category + ", title=" + title + ", grade=" + grade + ", poster="
				+ poster + ", stillcut=" + stillcut + ", director=" + director + ", producer=" + producer + ", actor="
				+ actor + ", genre=" + genre + ", feature=" + feature + ", rate=" + rate + ", voice=" + voice
				+ ", subtitle=" + subtitle + ", year=" + year + ", summary=" + summary + ", video=" + video
				+ ", runtime=" + runtime + ", hasEpisodes=" + hasEpisodes + ", hasTrailers=" + hasTrailers + ", view="
